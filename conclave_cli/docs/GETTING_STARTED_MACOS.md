...
```bash
echo 'alias conclave-env="source /path/to/conclave_cli/python/venv/bin/activate"' >> ~/.zshrc
source ~/.zshrc
```
...
2. Name: "Conclave"
3. Command: `/path/to/conclave_cli/python/venv/bin/python -m conclave.cli`
