...
cd /path/to/conclave_cli/python
...
```bash
echo 'alias conclave-env="source /path/to/conclave_cli/python/venv/bin/activate"' >> ~/.bashrc
source ~/.bashrc
```
...
source /path/to/conclave_cli/python/venv/bin/activate
...
Exec=gnome-terminal -- bash -c "source /path/to/conclave_cli/python/venv/bin/activate && conclave list; exec bash"
...
Environment="PATH=/path/to/conclave_cli/python/venv/bin:/usr/bin"
ExecStart=/path/to/conclave_cli/python/venv/bin/conclave run basic-ideator input.md
...
sudo chown -R $USER:$USER /path/to/conclave_cli/python
...
| Conclave venv | `/path/to/conclave_cli/python/venv/` |
